...
(function (StackFlame) {
    ...
    StackFlame.init = init;
    function onHomeClick(event) {
        event.preventDefault();
        resetEverything();
    }
    function onResetZoomClick(event) {
        event.preventDefault();
        if (flameGraph)
    ...
    function onUploadBtnClick(event) {
        ...
        if (loading)
            return;
        // FIXME! BOOO! Ugly
        d3.flamegraph = d3_flame_graph_1.flamegraph;
        eFileElem.click();
    }
    function onFilesUploaded(event) {
        loading = true;
        ...
        reader.onload = (evt) => __awaiter(this, void 0, void 0, function* () {
            const tree = yield parseCoreDump(evt.target.result);
            if (!tree) {
    ...
    function parseCoreDump(coreDump) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield parseStacks(stacks);
        });
    }
    function parseStacks(stacks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield buildFlameGraphTree("(root)", rootMap);
        });
    }
    function buildFlameGraphTree(name, tree) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    class ProgressMonitor {
        constructor(phaseCount, eProgress) {
